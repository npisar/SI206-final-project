...
def get_character_data(character_url):
    """
    Fetches and inserts detailed character data (id, name, rarity, vision, and character vision) into the Characters table.
    """
    all_character_data = []
...
# Insert data into character tables
